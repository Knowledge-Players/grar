...
class SimpleBubble extends WidgetContainer{
    ...
    public function new(?width:Float,?height:Float,?colors:Array<UInt>,?arrowX:Float=0,?arrowY:Float=0,?radius:Array<Float>,?line:Float=0,?colorLine:Int=0xFFFFFF,?shadow:Float=0,?gap:Float=5,?alphas:Array<Float>,?bubbleX:Float=0,?bubbleY:Float=0){
