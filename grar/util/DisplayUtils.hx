...
class DisplayUtils {
    ...
    **/
	public static function setBackground(bkg:String, container:Sprite, width:Float = 0, height:Float = 0, 
		alpha:Float = 1, x:Float = 0, y:Float = 0):Null<Bitmap>
	{
    ...
    **/
	public static inline function initSprite(?sprite:Sprite, width:Float = 1, height:Float = 1, color:Int = 0, 
		alpha:Float = 1, x:Float = 0, y:Float = 0):Sprite
	{
    ...
    **/
	...
	public static function initGradientSprite(?sprite: Sprite, width: Float = 1, height: Float = 1, 
		colors: Array<Int>, alphas: Array<Float>, x: Float = 0, y: Float = 0): Sprite
	{
		if(colors.length == 1)
	...
	**/
	public static inline function maskSprite(sprite: Sprite, maskWidth: Float = 1, maskHeight: Float = 1, 
		maskX: Float = 0, maskY: Float = 0):Void
	{
	...
	public static inline function drawElipse(?sprite:Sprite, colors:Array<Int>, ?alphas:Array<Float>, 
		radius: Array<Float>, x: Float = 0, y: Float = 0):Sprite
	{
		var s: Sprite;
		if(sprite == null)
			s = new Sprite();
